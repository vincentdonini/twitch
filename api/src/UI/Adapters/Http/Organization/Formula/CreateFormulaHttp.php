...
use App\Domain\Organization\Formula\CreateFormulaDTOInterface;
use App\UI\Adapters\Http\Common\HttpPayloadParser;
use Symfony\Component\Uid\Uuid;

final readonly class CreateFormulaHttp implements CreateFormulaDTOInterface
{
    ...
    {
        /** @var FormulaTypeEnum|null */
        return $this->parseEnum('type', FormulaTypeEnum::class);
    }
