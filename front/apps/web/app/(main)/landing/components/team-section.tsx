...
import { CardDecorator } from "@workspace/ui/components/card-decorator"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            We are a passionate team of innovators, builders, and problem-solvers dedicated to creating
