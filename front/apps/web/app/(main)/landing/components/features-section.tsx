...
import { ArrowRight, BarChart3, Crown, Database, Layout, Package, Palette, Users, Zap } from "lucide-react"
import { Button } from "@workspace/ui/components/button"
import { Badge } from "@workspace/ui/components/badge"
import { Image3D } from "@workspace/ui/components/image-3d"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Our marketplace provides curated blocks, templates, landing pages, and admin dashboards to help
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-base text-pretty">
                Our curated marketplace offers premium blocks and templates designed to save time and
                ensure consistency across your admin projects.
              </p>
            </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pe-4 pt-2">
              ...
              <Button size="lg" variant="outline" className="cursor-pointer">
                <a href="https://github.com/silicondeck/shadcn-dashboard-landing-template"
